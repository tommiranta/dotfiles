...
keymap.set("n", "<leader>ws", ":%s/\\s\\+$//<CR>") -- remove trailing whitespace
...
-- fzf
-- keymap.set("n", "<silent>", "<Leader>p :Files<CR>")
-- keymap.set("n", "<silent>", "<Leader>o :GFiles<CR>")
-- keymap.set("n", "<silent>", "<Leader>g :Rg<CR>")
-- keymap.set("n", "<silent>", "<Leader>b :Buffers<CR>")
-- keymap.set("n", "<Leader>m", ":b#<CR>")
-- keymap.set("n", "<Leader>x", ":bd<CR>")
-- keymap.set("n", "<leader>X", ":bufdo bd<cr>")
